...
SELECT * FROM (
  ...
  SELECT 'Kulthorn AE2410Y', 'KLS-0002', 'PT. BMC', 'Unit', '2026-01-01', 5
) AS src
...
SELECT * FROM (
  ...
  SELECT 'Kulthorn AE4440Y', 'KLS-0003', 'Unit', '2026-01-10', 2
) AS src
...
SELECT * FROM (
  ...
  SELECT 'PT. TIRIS INDO', 'Glodok, Jakarta', '021-222-333'
) AS src
